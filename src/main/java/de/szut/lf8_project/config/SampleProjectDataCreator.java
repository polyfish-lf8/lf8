...
public class SampleProjectDataCreator {
    ...
    public void run(ApplicationArguments args) {
        ...
        repository.save(new ProjectEntity(2L, 3L, 4L, 6L, new ArrayList<>(), "Hallo Jana", LocalDate.now(), LocalDate.now().plusDays(2)));
        repository.save(new ProjectEntity(3L, 4L, 5L, 7L, new ArrayList<>(), "Hallo Mika", LocalDate.now(), LocalDate.now().plusDays(3)));
        repository.save(new ProjectEntity(3L, 4L, 5L, 7L, new ArrayList<>(), "Hallo Waled", LocalDate.now(), LocalDate.now().plusDays(4)));
    }
}
